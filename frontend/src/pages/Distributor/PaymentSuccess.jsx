...
import { subValidatePayment } from "../../hooks/distributor/distributor";
...
const PaymentSuccess = () => {
  ...
  useEffect(() => {
    if (refId && distributor && subId && userId) {
      setErrorMsg("");
      const fetchStatus = async () => {
        try {
          const { data } = await subValidatePayment({
            userId,
  ...
  }, [refId, distributor, subId, userId, navigate]);

  if (!subId || !refId || !userId) {
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2 text-green-600">
                        <CheckCircle className="w-4 h-4" />
                        <span className="text-sm">
                          Full access granted to all features
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-green-600">
                        <CheckCircle className="w-4 h-4" />
